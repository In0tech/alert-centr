...
genie_info_bot_token = config.get('BUZZ_API', 'CSIRT_BOT_TOKEN')
buzz_csirt_chat_id = config.get('BUZZ_API', 'CSIRT_CHAT_ID')
BUZZ_URL = config.get('BUZZ_API', 'BUZZ_URL')
BUZZ_REPLY_URL = config.get('BUZZ_API', 'BUZZ_REPLY_URL')

'''
id 5e7b0f47-640a-5ee2-a342-90ed8ba2fa52
key 42008e35ff43cda7ce9253721c43cfef
тестовый Базз - test.buzz.beeline.ru
базовый url - testcts1.buzz.beeline.ru
'''
# test
genie_info_bot_token = "SFMyNTY.g2gDbQAAACQ1ZTdiMGY0Ny02NDBhLTVlZTItYTM0Mi05MGVkOGJhMmZhNTJuBgCniDw7nwFiAAFRgA.htryVzcecKPbXyXEC8HeKpgUk6o38ID6pE6KiIsoCsQ"
buzz_csirt_chat_id = "3e48fa56-f988-59d1-bc87-3ab4bf4445eb"
BUZZ_URL="https://testcts1.buzz.beeline.ru:443/api/v4/botx/notifications/direct"
BUZZ_REPLY_URL="https://testcts1.buzz.beeline.ru:4443/api/v3/botx/events/reply_event"
...
"""
            ...
            send_notification(genie_info_bot_token, buzz_csirt_chat_id, genie_event_text, CURRENT_OPEN_NOTIFICATIONS[key]['sync_id'])
...
"""
                ...
                res = send_notification(genie_info_bot_token, buzz_csirt_chat_id, genie_event_text)
